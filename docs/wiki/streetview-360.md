...
Cuidado adicional desde 2026-08-14: **existem três superfícies imersivas**. A cena de primeira pessoa ([[primeira-pessoa-3d]]) não tem minimapa: a posição do observador é local, em metros, sem georreferenciamento. Desde 2026-09-19 os comentários dessa cena persistem e sincronizam na coleção de comentários do mapa, com coordenadas locais e referência ao recurso do catálogo; a presença transmite a posição da caminhada. Não se deve interpretar esses metros como longitude e latitude.
