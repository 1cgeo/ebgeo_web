...
- [[viewshed-3d]] - a análise de visibilidade dentro do visualizador Cesium: o contrato com o chamador, as cinco recusas do shader, e as duas propriedades do motor que só a medição entrega.
...
- [[luminosidade-pitcic]] - os dados solares e lunares do PITCIC num ponto: as três leituras da doutrina, as armadilhas de dia civil e de dia UTC, e a referência contra o USNO.
- [[meteorologia-pitcic]] - a previsão da matriz do PITCIC num ponto: o navegador consulta a Open-Meteo sem credencial nem Referer, o modelo GFS fixo e as regras de agregação conferidas contra a própria fonte.
