...
Nomes geográficos também não, e desde 2026-08-19 por um motivo mais forte que a ausência de coluna: **nada** os escopa. A busca de topônimo não tem restrição de acesso nenhuma, por decisão de produto, e o eixo que existia ali (marca de privacidade na linha mais concessão espacial por zona, por usuário e por grupo) saiu medido como morto. Ver [[gazetteer-nomes-geograficos]].
