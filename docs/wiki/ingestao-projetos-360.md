...
> [!CONTRADICAO 2026-07-18] `backend/src/modules/streetview360/sv360.admin.service.js:224-225` e `scripts/sv360-import.js:27-29` descrevem o caminho online como "Postgres primeiro, swap depois". É o inverso: `ingestBundle` é swap-first-then-commit (`backend/src/modules/streetview360/sv360.ingest.js:411-428`). Os comentários são resquício da ordem anterior (pré-FIX-3). Valem para a leitura, não para o comportamento.

> [!CONTRADICAO 2026-07-18] `backend/src/modules/streetview360/sv360.service.js:306-309` diz que o arquivo escrito na ingestão é `{slug}.webp`; o código grava `{orgId}__{slug}.webp` (`backend/src/modules/streetview360/sv360.admin.service.js:269`). O `:slug` da URL continua sendo só o slug, a tradução para o nome org-keyed acontece no servidor.
