...
Conflito é LWW por ordem de chegada ao servidor, não por timestamp: [[modelo-conflito-lww]], [[sintese-nao-e-crdt]]. Para depurar convergência ponta a ponta, [[syncledger]].
