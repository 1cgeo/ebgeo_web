...
O trabalho pesado de `applyRemoteSnapshot` não é salvar o mapa, é espalhar o que o backend guarda como colunas para os side-stores que o resto do app lê (`reshapeSnapshotMap`, `:1087`).
