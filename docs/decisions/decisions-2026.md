...
- **Guardas:** `frontend/tests/unit/somente-leitura-censo.test.js` (as âncoras de cada painel) e `frontend/tests/e2e-ui/notas-do-mapa-somente-leitura.repro.spec.js`. A regra está em `.claude/rules/architecture.md`, §UI Architecture.
