...
- 2026-09-26: a figura de slide por referência usa um src sentinela em https, que a aba de build antigo não apaga, e a saída "enviar as pendências a este atlas" do resgate só aparece para a mesma conta e com a cópia local intocada desde o resgate (decisão do dono), [registro](decisions-2026.md).
- 2026-09-26: as sete decisões que ficaram das pendências: o CSS se ajusta ao navegador mínimo, só o spec de estilo muda com os derivados do zoom, o gatilho da coleta de órfãs é medido antes da primeira marcação, as camadas de exemplo do catálogo saem, a trava e as cores de selo viajam no envio e no `.ebgeo`, a figura colada de outro atlas é consertada e o conteúdo dos slides sai da op de BRIEFING (decisão do dono), [registro](decisions-2026.md).
