...
6. **Feito em 14/09/2026 (D9):** os seis vendors sem consumidor e a segunda cópia do three em `frontend/public/street_view/build/` foram podados; o inventário passou a acusar código de terceiro fora das pastas cobertas. Em curso, por decisão do dono do mesmo dia: Cesium, GDAL, Turf, milsymbol e docsify migram para o npm, e Cesium e MapLibre sobem para a última versão publicada, um commit por biblioteca com captura lida.
