...
| B10 | segurança e dependências | inventário reproduzível por script; autorização revisada (A1..A15); V1..V8 executados (D9); viewshed reescrito (D15) e tutorial na quinta entrada (D16) em 15/09/2026, `frontend/public/vendors/` vazia; **resta** só o refazer do inventário e do `npm audit` sobre o SHA candidato |
