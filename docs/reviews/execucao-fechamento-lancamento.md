...
A [retrospectiva das correções do dia](correcoes-2026-09-12/README.md) relaciona os commits conferidos e os documentos por assunto, incluindo migração, monitoramento e as etapas anteriores de sincronismo. As evidências ali descritas são históricas; a escrita desses documentos não repete a homologação do produto.
