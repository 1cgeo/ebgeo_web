...
- **A autoridade morre com quem a exercia.** Desativar conta ou organização tira os acessos da pessoa E o que ela sustentava: o empréstimo dos atlas de que ela é dona, os grupos de que ela é dona, e as concessões que ela originou. Propaga por PREDICADO na leitura seguinte, sem varredura. Lacuna medida e registrada: `fn_principal_vivo` pergunta pela CONTA, não pela AUTORIDADE, então rebaixado com conta ativa ainda sustenta o que concedeu.
