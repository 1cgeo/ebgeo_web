...
| [017_imagens_orfas.sql](017_imagens_orfas.sql) | A coleta de imagem órfã: a marca de quando uma imagem ficou sem citação, o gatilho que a zera quando uma citação aparece ou some, e a ação de trilha da remoção. Nada ali apaga coisa alguma. |
| [018_catalogo_sem_exemplos.sql](018_catalogo_sem_exemplos.sql) | As quatro camadas de exemplo do catálogo, com endereço em localhost, desativadas onde a URL ainda é a de exemplo (decisão do dono de 2026-09-26). Os testes e o seed de desenvolvimento as semeiam por [catalogo-de-exemplo.js](../catalogo-de-exemplo.js). |
