 ...
 * colunas (migração 011) e por isso a função abaixo os RECEBE em vez de deduzi-los.
 */
...
export function gradeDoNivel(descritor, level) {
  ...
  // não tem tile nenhum. O CHECK da migração 011 impede isso no banco; aqui a guarda
