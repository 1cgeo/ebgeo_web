...
describe('buildCoordinationLineWidthExpression', () => {
    // The VALUE the expression paints, against this model and MapLibre's own
    // parser, lives in coordination-line-width-expression.test.js. Here it is
    // only the shape: a zoom curve, not the property lookup it used to be.
