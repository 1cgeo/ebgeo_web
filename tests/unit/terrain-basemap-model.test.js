 ...
 * vetorial com o terreno ligado (docs/desempenho-terreno-2026-09-04.md), e cobra por
 * isso uma cobertura menor: fora do recorte gerado, o mapa fica BRANCO. Toda a regra
 * abaixo protege duas coisas que uma troca automatica quebra facil:
 *
...
/** As cinco bases que o STYLE_MAP registra, com as tres que a config habilita. */
const DISPONIVEIS = ['carta-topografica', 'carta-ortoimagem', 'bdgex'];

/** Recorte sul, o mesmo do `map2d.bounds`: [oeste, sul, leste, norte]. */
...
describe('isCenterInsideBounds', () => {
    ...
    it('NAO trata caixa que cruza o antimeridiano, e a recusa inteira', () => {
        // Nada no repositorio trata antimeridiano (zero ocorrencias em src/), e um
        // tratamento inventado aqui seria a unica regra da casa a fazer isso. Uma
        // caixa com oeste > leste desliga a troca: e o lado seguro, e o unico
        // acervo em jogo e o do sul do Brasil.
...
describe('decideTerrainBasemap ao ligar o terreno', () => {
    ...
    it('com a chave nula nao faz nada e nao lembra nada', () => {
        // O padrao do repositorio. A base raster que compensa nao existe aqui:
        // vive na configuracao de cada implantacao.
    ...
    it('nao faz nada quando a preferida nao esta na lista de bases utilizaveis', () => {
        // A lista e a intersecao do STYLE_MAP com as habilitadas na config: uma
        // base desabilitada e uma base sem estilo registrado caem no mesmo buraco.
