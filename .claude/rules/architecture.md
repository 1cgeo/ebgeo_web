...
- **Páginas sem mapa**: `projects/` e `admin/` são entries HTML próprios (`atlas.html`, `admin.html`), não telas do mapa — ver §Páginas e chunks antes de importar qualquer coisa delas.
