...
// The toast module DIRECTLY, never the `@utils` barrel: the barrel reaches the
// store through `feature_navigation_utils`, and this file sits in the lazy
// viewer chunk, which has no business pinning the store graph.
