 ...
 *
 * HTTP_ONLY ("sem tempo real", owner's decision of 2026-09-24) is the fifth state: the server
 ...
 * `connected` frame, or to RECONNECTING when the HTTP stops answering too. The rules live in
 * `sem-tempo-real.js`.
 *
