...
export const LAYER_THUMBNAILS = {
    'carta-topografica': {
        ...
        label: 'Topográfica',
        shortLabel: 'Topo',
        thumbnail: './images/layers/carta-topografica-thumb.png',
    ...
    'carta-ortoimagem': {
        ...
        label: 'Ortoimagem',
        shortLabel: 'Orto',
        thumbnail: './images/layers/carta-ortoimagem-thumb.png',
    ...
    'osm': {
        ...
        label: 'OpenStreetMap',
        shortLabel: 'OSM',
        thumbnail: './images/layers/osm-thumb.png',
    ...
    'imagens': {
        ...
        label: 'Satélite',
        shortLabel: 'Satélite',
        thumbnail: './images/layers/imagens-thumb.png',
    ...
    'bdgex': {
        ...
        label: 'BDGEx',
        shortLabel: 'BDGEx',
        thumbnail: './images/layers/bdgex-thumb.png',
