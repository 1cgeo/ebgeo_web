...
export const engineeringFields = {
  2: { fixed: 'Triângulo arredondado e haste. O 3 dentro do triângulo é variável.', fields: [backgroundField(), valueField('order', 'Número do ponto crítico', '3', 'integer', 'Identifica a referência na legenda. Não é quantidade nem classe e não deve ser fixado em 3.')], extra: 'A descrição da restrição pertence à legenda/atributos, fora do glifo.' },
  ...
  8: { fixed: 'Círculo dividido, chamada, roda, lagarta e setas de um/dois sentidos. Todos os oito números do exemplo são dados.', fields: [backgroundField(), orderField('3'),
    ...
    flagField('underClearance', 'Sublinhar gabarito inferior ao padrão', true), flagField('underLength', 'Sublinhar comprimento inferior ao padrão'), flagField('underWidth', 'Sublinhar largura inferior ao padrão')
  ...
  9: { fixed: 'Círculo dividido e chamada. 80 é classe; 40 é número de ordem.', fields: [backgroundField(), valueField('class', 'Classe da ponte', '80', 'integer'), orderField('40')] },
