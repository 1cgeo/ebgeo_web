...
const h = vi.hoisted(() => {
    ...
    const servidor = {
        ...
        responder(desde, temRetrato = false) {
            ...
            // contagem; os casos deste arquivo usam caudas de uma op, entao ele nao muda nenhum. Pelo
            // SOCKET o servidor responde o aviso de re-puxar em vez do retrato; o arquivo que modela
            // e exercita os dois canais e `cauda-longa-vira-retrato.repro.test.js`.
