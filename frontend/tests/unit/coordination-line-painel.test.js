// Path: tests/unit/coordination-line-painel.test.js
...
vi.mock('@tools/helpers/index.js', () => ({
    ...
    // NAO existe `createPanelHeader` neste ramo: o painel nao monta cabecalho, e o bloco de
    // identificacao vem de `sidebar/components/feature-identification.js`.
    createActionButtons: () => {},
}));
