// Path: tests/unit/boundary-split-real-turf.test.js

/**
 * @fileoverview Cutting a boundary, measured against the REAL turf bundle the
 * app ships.
 *
...
beforeAll(async () => {
    ...
    ({ splitSpineAtPoint, splitSymbolInstances } =
        await import('../../src/js/tool_manager/helpers/boundary-split.model.js'));
...
describe('cutting a boundary keeps the echelon on the same ground', () => {
    ...
    // sit a few metres apart at the cut, and the symbol inherits part of it.
