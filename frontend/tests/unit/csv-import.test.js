...
describe('csvToGeoJSON', () => {
    ...
    // The 1000-row cap was removed on 2026-09-02: a CSV larger than the old limit
    // must now convert in full, and the only rows lost are the invalid ones. These
    // two cases are exactly what a reinstated cap would break.
