 ...
 * because the defect is open is `it.fails`, with the defect it closes named in the comment. `it.fails` is green while the defect lives and turns RED on the commit
