...
describe('o que o catalogo diz do 290202', () => {
    ...
    it('FILLED_SYMBOL_CODES tem o fosso e NAO tem nenhum simbolo de anel fechado', () => {
        // Uma camada de fill do MapLibre FECHA e pinta qualquer linha que receba:
        // medido no navegador em 2026-09-03, sem filtro ela pintou o miolo do
        // losango 290199, o de toda argola de concertina, e ate a area entre uma
        // espinha dobrada e a sua corda. Marcar `filled` num simbolo de anel
        // fechado enche a tela, e este teste e o que reprova isso antes de la.
        //
        // NESTE RAMO a `coordination-line-fill-layer` NAO le esta lista: ela
        // filtra por `['geometry-type']`, porque `layers/styles/` esta no chunk
        // `core` e nao pode importar `military_tools/` (o teto de peso da pagina
        // do mapa prende esse chunk em zero modulos ansiosos). O ultimo bloco
        // deste teste e o que amarra as duas leituras: a lista e o tipo de
        // geometria selecionam o MESMO conjunto, simbolo a simbolo.
