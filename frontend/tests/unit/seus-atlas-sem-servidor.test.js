...
// O `document` de mentira, de um helper: `tests/unit/menu-do-cartao-local.test.js` monta a MESMA
// seção, e duas cópias do dublê seriam duas definições do que "chegou à tela" significa.
import { fire, byTestid, allText, makeDocumentStub } from '../helpers/dom-double.js';
