 ...
 * hillshade and ~60 GeoJSON sources) just to pick a cursor. The hover handlers
 * already discard everything but their own family, so they can name the layers
 * up front and pay for those alone.
 *
