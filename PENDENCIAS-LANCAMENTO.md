...
- Reescrever os quatro testes do backend que dependem da plataforma (item 3) para falhar igual em Windows e Linux: um alvo que não seja diretório, e um guarda de tempo que segure o laço.
