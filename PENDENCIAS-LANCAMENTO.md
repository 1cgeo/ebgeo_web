...
- Figura de slide de briefing por referência, como as fotos (o custo medido está no item 3). Mapeado em 2026-09-26, sem código ainda:
  ...
  - DECIDIDO pelo dono em 2026-09-26: a referência é um src sentinela em https (https://figura.ebgeo/<uuid>), e não data-figura, porque a aba de build antigo apagaria o atributo ao editar o texto do slide e a figura sumiria para todos; com o sentinela ela vê a figura quebrada e preserva a referência. No desenho acima, onde se lê data-figura, leia o sentinela.
