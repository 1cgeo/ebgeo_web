...
export const UI_DATA = {
  pointsList: [
    ...
    { code: "SUPPLY_IV", label: "Suprimento - Classe IV (Material de Construção)", category: "Logística" },
    { code: "SUPPLY_V", label: "Suprimento - Classe V (Munição)", category: "Logística" },
    { code: "SUPPLY_VI", label: "Suprimento - Classe VI (Material de Engenharia)", category: "Logística" },
    { code: "SUPPLY_VII", label: "Suprimento - Classe VII (Viaturas)", category: "Logística" },
    { code: "SUPPLY_VIII", label: "Suprimento - Classe VIII (Material de Saúde)", category: "Logística" },
    { code: "SUPPLY_IX", label: "Suprimento - Classe IX (Sobressalentes)", category: "Logística" },
    { code: "SUPPLY_X", label: "Suprimento - Classe X (Material não-militar)", category: "Logística" },
    { code: "SUPPLY_Agua", label: "Suprimento - Água", category: "Logística" },
    { code: "SUPPLY_Outras", label: "Suprimento - Outras Classes", category: "Logística" },
