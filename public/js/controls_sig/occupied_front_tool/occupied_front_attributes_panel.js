...
export function addOccupiedFrontAttributesToPanel(panel, selectedFeatures, occupiedFrontControl, selectionManager, uiManager) {
    ...
    const opacityControl = createSliderWithInput({
        ...
        unit: '',
        onChange: (value) => {
            occupiedFrontControl.updateFeaturesProperty(selectedFeatures, 'opacity', value);
            uiManager.updateSelectionHighlight();
        }
    });
    ...
    saveButton.onclick = () => {
        occupiedFrontControl.saveFeatures(selectedFeatures, initialPropertiesMap);
    ...
    discardButton.onclick = () => {
        occupiedFrontControl.discardChangeFeatures(selectedFeatures, initialPropertiesMap);
        selectionManager.deselectAllFeatures();
    };
    ...
    if (selectedFeatures.length === 1) {
        ...
        setDefaultButton.onclick = () => {
            occupiedFrontControl.setDefaultProperties({
