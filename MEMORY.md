...
Fatos **duráveis** do sistema EBGeo. Injetado em toda sessão, teto de 200 linhas / 25KB (acima disso o excedente é descartado em silêncio; há teste que falha antes). Ao passar de ~80%, consolide na retrospectiva e mova o detalhe para [`docs/wiki/`](docs/wiki/index.md).
